...
public class UsersDTO implements Serializable{ 
    ...
    public UsersDTO(int user_id, String full_name, String email, String phone) {
    ...
    public UsersDTO(String full_name) {
        this.full_name = full_name;
    }


    public UsersDTO(int user_id, String full_name, String user_name, String email, String phone) {
        this.user_id = user_id;
        this.full_name = full_name;
    ...
    public UsersDTO(int user_id, String full_name, String user_name, String password, String email, String phone, String edit_date) {
        this.user_id = user_id;
        this.full_name = full_name;
        this.user_name = user_name;
