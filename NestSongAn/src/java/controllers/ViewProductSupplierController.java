...
public class ViewProductSupplierController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (QuantityProductDTO quantityProductDTO : listProduct) {
                System.out.println(quantityProductDTO);
            }
            request.setAttribute("listProduct", listProduct);
        } catch (SQLException ex) {
            Logger.getLogger(ViewProductSupplierController.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
            request.getRequestDispatcher("view/supplier/view_product.jsp").forward(request, response);
        }
    }
