 ...
 */
@WebServlet(name = "OfflineCartController", urlPatterns = {"/add-cart-offline"})
public class OfflineCartController extends HttpServlet {
        ...
        try {
            ...
            switch (command) {
                case "insert":
                    ...
                    if (pC.getQuantity() == 0) {
                        response.sendRedirect("my-cart-offline?bid=" + branch_id1 +"");
...
//                    url = "/cart.jsp";
                        url = "my-cart-offline?bid=" + branch_id1 +"";
                    }
