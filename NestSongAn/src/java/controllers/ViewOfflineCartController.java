 ...
 */
@WebServlet("/my-cart-offline")
public class ViewOfflineCartController extends HttpServlet{
...
//        System.out.println("session: " + branch_id1);
        ...
        req.getRequestDispatcher("view/staff/offline-cart.jsp").forward(req, resp);
    }
