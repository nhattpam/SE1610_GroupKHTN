 ...
 * @author Admin
 */
@WebServlet("/yen-tho-con-long")
public class ViewCategory4Controller extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ProductDTO> listPaging = dao4.pagingProductByCategory(index, 4);
        req.setAttribute("listPaging", listPaging);
        
        
        req.getRequestDispatcher("category/yen-tho-con-long.jsp").forward(req, resp);
    }
