 ...
 * @author Admin
 */
@WebServlet("/chan-to-yen")
public class ViewCategory5Controller extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ProductDTO> listPaging = dao4.pagingProductByCategory(index, 5);
        ...
        req.getRequestDispatcher("category/chan-to-yen.jsp").forward(req, resp);
    }
