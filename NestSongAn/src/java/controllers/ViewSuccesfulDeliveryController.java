 ...
 * @author HUNG
 */
@WebServlet(name = "ViewSuccesfulDeliveryController", urlPatterns = {"/ViewSuccesfulDeliveryController"})
public class ViewSuccesfulDeliveryController extends HttpServlet {
