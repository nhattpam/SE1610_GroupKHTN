 ...
 */
@WebServlet("/nuoc-yen")
public class ViewCategory6Controller extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ProductDTO> listPaging = dao4.pagingProductByCategory(index, 6);
        ...
        req.getRequestDispatcher("category/nuoc-yen.jsp").forward(req, resp);
    }
