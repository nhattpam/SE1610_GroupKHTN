 ...
 */
@WebServlet("/yen-tuoi")
public class ViewCategory3Controller extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ProductDTO> listPaging = dao4.pagingProductByCategory(index, 3);
        req.setAttribute("listPaging", listPaging);
        
        
        req.getRequestDispatcher("category/yen-tuoi.jsp").forward(req, resp);
    }
