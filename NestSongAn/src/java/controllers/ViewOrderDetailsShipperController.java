 ...
 * @author haph1
 */
@WebServlet(name = "ViewOrderDetailsShipperController", urlPatterns = {"/shipperorder_details"})
public class ViewOrderDetailsShipperController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int sd = Integer.parseInt(request.getParameter("sd"));
            ...
            request.getRequestDispatcher("view/shipping/view_oderdetailshipper.jsp").forward(request, response);
