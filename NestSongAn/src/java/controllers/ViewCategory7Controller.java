 ...
 * @author Admin
 */
@WebServlet("/to-yen-huyet")
public class ViewCategory7Controller extends HttpServlet{
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<ProductDTO> listPaging = dao4.pagingProductByCategory(index, 7);
        req.setAttribute("listPaging", listPaging);
        
        
        req.getRequestDispatcher("category/to-yen-huyet.jsp").forward(req, resp);
    }
