...
public class ViewInvoiceController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url="view/supplier/view_invoice.jsp";
        try {
            QuantityProductDAOImpl quantityProductDAOImpl = new QuantityProductDAOImpl();
            ImportInvoiceDAO dao =new ImportInvoiceDAOImpl();
            List<ImportInvoiceDTO> list;
            //
            list=dao.getInvoice();
            //
            int q = quantityProductDAOImpl.getQuantityProduct();
