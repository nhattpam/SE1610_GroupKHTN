...
<html>
    ...
    <body>
        ...
        <!-- //header -->
        <!-- banner -->
        <jsp:include page="banner_category.jsp" />
        <!-- banner -->
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3"  style="display: flex;">
                            <img  src="images/chat-luong-to-yen-04-100x100.png"  class="img-responsive" style="width: 30px; height: 30px;" />
                            <p style="margin-left: 20px;">Tổ yến đạt chuẩn xuất khẩu</p>
                        </div>
                        <div class="col-md-3"  style="display: flex;">
                            <img  src="images/chat-luong-to-yen-01-100x100.png" class="img-responsive" style="width: 30px; height: 30px;" />
                            <p style="margin-left: 20px;">Đảm bảo vệ sinh an toàn thực phẩm</p>
                        </div>
                        <div class="col-md-3"  style="display: flex;">
                            <img  src="images/chat-luong-to-yen-03-100x100.png" class="img-responsive" style="width: 30px; height: 30px;" />
                            <p style="margin-left: 20px;">Tổ yến nguyên chất, hương vị thơm ngon</p>
                        </div>
                        <div class="col-md-3"  style="display: flex;">
                            <img  src="images/chat-luong-to-yen-02-100x100.png" class="img-responsive" style="width: 30px; height: 30px;" />
                            <p style="margin-left: 20px;">Giá tốt nhất thị trường</p>
                        </div>
            ...
            <div class="top-brands">
                ...
                <div class="container"  style="margin-top: 5px;">
                    <div class="col-md-12 text-center">
                        ...
                        <span style="font-size: 40px; color: #4a5d43; font-family: 'Nunito Sans', sans-serif; font-weight: bold;">Sản phẩm</span>&nbsp;&nbsp;
                        <span style="color: #d5a554; font-size: 35px; font-family: 'Nunito Sans', sans-serif; font-weight: bold;">nổi bật</span>
                        <br>
                        <br>
                        <h4 style="font-family: 'Nunito Sans', sans-serif; font-weight: bold;">Các sản phẩm tổ yến hiện đang được ưa chuộng.</h4>
                        <br>
                        <br>
                        ...
                        <div class="col-md-9 w3l_fresh_vegetables_grid_right">
                            ...
                            <div class="agileinfo_move_text">
                                <div class="agileinfo_marquee">
                                    <h4 style="font-family: 'Nunito Sans', sans-serif; font-weight: bold;">Giá <span class="blink_me">Rẻ bất ngờ</span> còn chần chờ gì nữa!</h4>
                                </div>
