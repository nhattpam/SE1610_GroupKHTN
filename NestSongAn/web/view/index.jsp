    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="w3ls_logo_products_left1">
                    <ul class="phone_email">
                        ...
                        <li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="khtnholdings.work@gmail.com">store@grocery.com</a></li>
                    </ul>
                </div>
                <div class="clearfix"> </div>
            </div>
        ...
        <div class="banner_bottom">
            <div class="row">
                ...
                <div class="col-md-4">
                    <span style="font-size: 40px; color: #4a5d43; font-family: "Nunito Sans", sans-serif;">Về</span>&nbsp;&nbsp;
                    <span style="color: #d5a554; font-size: 35px; font-family: "Nunito Sans", sans-serif;">Song Ân</span>
                    <br><br>
                    <p style="text-align: justify; font-family: "Nunito Sans", sans-serif;>
